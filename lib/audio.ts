...
export class PitchDetector {
  ...
  async init() {
    ...
    try {
      ...
      // Create ArrayBuffer first, then Uint8Array from it to satisfy TypeScript strict types
      // This ensures the Uint8Array has ArrayBuffer type instead of ArrayBufferLike
